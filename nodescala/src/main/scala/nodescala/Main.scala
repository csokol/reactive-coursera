...
////    //    or the user enters some text and presses ENTER
    val delay: Future[Unit] = Future.delay(20 seconds)
    val input: Future[String] = Future.userInput("Hit ENTER to cancel... ")
    val terminationRequested: Future[String] = Future.any(List(delay, input)).continue(t => "ended")
////
////    // TO IMPLEMENT
